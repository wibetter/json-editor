...
function B(e, t) {
  ...
  if (e && '{}' !== JSON.stringify(e)) {
    ...
    'object' === o || 'func' === o || 'style' === o || 'data' === o
      ? (!r && n.object ? (n.object += 1) : r || (n.object = 1), (n = I(e, n)))
      : 'array' === o
  ...
  ue = (function () {
    function e(e) {
      void 0 === e && (e = 'Atom@' + K()),
        ...
        (this.lowestObserverState = qe.NOT_TRACKING);
    }
    return (
      ...
      (e.prototype.reportChanged = function () {
        bt(),
          (function (e) {
            if (e.lowestObserverState === qe.STALE) return;
            (e.lowestObserverState = qe.STALE),
              e.observers.forEach(function (t) {
                t.dependenciesState === qe.UP_TO_DATE &&
                  (t.isTracing !== Ie.NONE && Ot(t, e), t.onBecomeStale()),
                  (t.dependenciesState = qe.STALE);
              });
          })(this),
          mt();
      }),
...
var Pe = {
    box: function (e, t) {
      arguments.length > 2 && Le('box');
      var r = De(t);
      return new at(e, Re(r), r.name, !0, r.equals);
    },
    array: function (e, t) {
      arguments.length > 2 && Le('array');
      var r = De(t);
    ...
    map: function (e, t) {
      arguments.length > 2 && Le('map');
      var r = De(t);
      return new sr(e, Re(r), r.name);
    },
    set: function (e, t) {
      arguments.length > 2 && Le('set');
      var r = De(t);
      return new pr(e, Re(r), r.name);
    },
    object: function (e, t, r) {
      'string' == typeof arguments[1] && Le('object');
      var n = De(r);
...
function ze(e) {
  switch (e.dependenciesState) {
    case qe.UP_TO_DATE:
      return !1;
    case qe.NOT_TRACKING:
    case qe.STALE:
      return !0;
    case qe.POSSIBLY_STALE:
      for (
        ...
        if (ut(a)) {
          ...
          if (e.dependenciesState === qe.STALE) return Xe(r), Ye(t), !0;
        }
      }
...
function Ke(e, t, r) {
  ...
  return (
    ...
    (function (e) {
      ...
      n !== qe.UP_TO_DATE && ((e.dependenciesState = n), e.onBecomeStale());
    })(e),
    (function (e) {
...
function Je(e) {
  ...
  e.dependenciesState = qe.NOT_TRACKING;
}
function He(e) {
  var t = We();
  try {
...
function Ze(e) {
  if (e.dependenciesState !== qe.UP_TO_DATE) {
    e.dependenciesState = qe.UP_TO_DATE;
    for (var t = e.observing, r = t.length; r--; )
      t[r].lowestObserverState = qe.UP_TO_DATE;
  }
}
var Qe = 0,
  et = 1,
...
var st = (function () {
    function e(e) {
      (this.dependenciesState = qe.NOT_TRACKING),
        (this.observing = []),
        ...
        (this.runId = 0),
        (this.lastAccessedBy = 0),
        (this.lowestObserverState = qe.UP_TO_DATE),
    ...
    return (
      (e.prototype.onBecomeStale = function () {
        !(function (e) {
          if (e.lowestObserverState !== qe.UP_TO_DATE) return;
          (e.lowestObserverState = qe.POSSIBLY_STALE),
            e.observers.forEach(function (t) {
              t.dependenciesState === qe.UP_TO_DATE &&
                ((t.dependenciesState = qe.POSSIBLY_STALE),
                t.isTracing !== Ie.NONE && Ot(t, e),
                t.onBecomeStale());
            });
        })(this);
      }),
                  ...
                  (e.lowestObserverState = qe.STALE),
                    e.observers.forEach(function (t) {
                      t.dependenciesState === qe.POSSIBLY_STALE
                        ? (t.dependenciesState = qe.STALE)
                        : t.dependenciesState === qe.UP_TO_DATE &&
                          (e.lowestObserverState = qe.UP_TO_DATE);
                    });
                })(this))
            : ze(this) &&
      ...
      (e.prototype.trackAndCompute = function () {
        ...
        var e = this.value,
          t = this.dependenciesState === qe.NOT_TRACKING,
...
function Ut(e, t, r, n) {
  ...
  var o = Lt((n = De(n)));
  return Ee(e), fr(e, n.name, o.enhancer), t && qt(e, t, r, o), e;
}
function Lt(e) {
...
var Jt = {
  ...
  set: function (e, t, r) {
    return !!Kt(t) && (Gt(e, t, r), !0);
  },
  deleteProperty: function (e, t) {
    return !!Kt(t) && (Ft(e).remove(t), !0);
  },
  ownKeys: function (e) {
...
var er = (function () {
    function e(e, t, r) {
      (this.owned = r),
        ...
        (this.atom = new ue(e || 'ObservableArray@' + K())),
...
function fr(e, t, r) {
  ...
  'production' !== process.env.NODE_ENV &&
    ...
    Y(e) || (t = (e.constructor.name || 'ObservableObject') + '@' + K()),
...
export {
  ...
  O as isSelect,
  f as isString,
  Lr as isStructuredSchema,
  m as isTimeStr,
  d as isURL,
  q as json2schema,
  Qr as json2treeData,
  L as keyRoute2indexRoute,
