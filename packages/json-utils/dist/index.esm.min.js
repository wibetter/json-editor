    ...
    (t =
      e && S(e)
        ...
        : e && F(e)
          ...
          : (function (e) {
              var t = '';
              if (x(e)) t = r(b.boolean);
              else if (O(e)) t = r(b.number);
              else if (j(e)) t = r(b.url);
              else if (q(e)) t = r(b.date);
              else if (k(e)) t = r(b['date-time']);
              else if (N(e)) t = r(b.time);
              else if ($(e)) t = r(b.color);
              else
                try {
                  t = O(JSON.parse(e)) ? r(b.input) : r(b.json);
                } catch (i) {
                  t = e && e.length > 30 ? r(b.textarea) : r(b.input);
                }
              return t;
            })(e)),
    t
...
function E(e, t) {
  ...
  if (e && '{}' !== JSON.stringify(e)) {
    ...
    'object' === a || 'func' === a || 'style' === a || 'data' === a
      ? (!r && i.object ? (i.object += 1) : r || (i.object = 1), (i = J(e, i)))
      : 'array' === a
...
function A(e) {
  ...
  if ('datasource' === t.type) {
    ...
    'local' === l
      ? ((t = r(g.local)).properties.data.default = u ? r(u) : '{}')
      : ((t = r(g.remote)).properties.data.default = u ? r(u) : 'http://xxx'),
...
export {
  ...
  E as metaElemAnalyzer,
  V as moveBackward,
  Q as moveForward,
  r as objClone,
  B as oldSchemaToNewSchema,
  A as oldSchemaToNewSchemaV1,
  W as registerExpectType,
  te as schema2json,
