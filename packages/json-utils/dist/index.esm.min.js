...
function p(e, t, i) {
  var a = t;
  if ((i && (a = r(t)), e))
    for (var p = e.split('-'), n = 0, o = p.length; n < o; n++) {
      var l = p[n];
      l && (a = a && a[l]);
    }
  return a;
...
function l(e, t) {
  for (var r = t, i = '', a = e.split('-'), p = 0, n = a.length; p < n; p++) {
    var o = a[p];
    ...
    (t =
      e && J(e)
        ...
        : e && $(e)
          ...
          : (function (e) {
              var t = '';
              if (F(e)) t = r(h.boolean);
              else if (N(e)) t = r(h.number);
              else if (q(e)) t = r(h.url);
              else if (k(e)) t = r(h.date);
              else if (D(e)) t = r(h['date-time']);
              else if (R(e)) t = r(h.time);
              else if (A(e)) t = r(h.color);
              else
                try {
                  t = N(JSON.parse(e)) ? r(h.input) : r(h.json);
                } catch (i) {
...
function W(e) {
  ...
  if (
    ...
    if (i.quantity && J(i.quantity) && i.quantity.default) {
      ...
      p.properties.quantity.default = 'percent' === n ? '%' : n;
    }
    t = p;
  }
...
function C(e, t) {
  ...
  if (J(e) && 'object' === e.type) {
    var n = e,
      o = t;
    a(o) && a(n.default) && typeof o != typeof n.default && (o = void 0);
    var l = a(o) ? o : n.default;
    if ('dynamic-data' === p)
      (i = r(j)),
...
export {
  ...
  oe as getNextIndexRoute,
  ne as getParentIndexRoute,
