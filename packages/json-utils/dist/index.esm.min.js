...
function k(e, r) {
  if ((D(e) && !D(r)) || (!D(e) && D(r)) || typeof e != typeof r) return !1;
...
function F(e, r) {
  ...
  return (
    ...
    !(
      ...
      !(
        (D(e.id) && e.id === r.id) ||
        (D(e.lastUpdateTime) && e.lastUpdateTime === r.lastUpdateTime)
      )
    ) ||
    t(e, r)
  );
...
function ie(e, t) {
  ...
  if (j(e) && 'object' === J(e.type)) {
    ...
    let l = t;
    D(l) &&
      ((D(a.default) && typeof l != typeof e.default) || !j(l)) &&
      (l = void 0);
    const n = D(l) ? l : a.default;
    if ('dynamic-data' === i)
      ((r = $(o)),
...
function ae(e, t) {
  ...
  if (e && 'array' === J(e.type)) {
    let i = t;
    D(i) &&
      ((D(e.default) && typeof i != typeof e.default) || !g(i)) &&
      (i = void 0);
    const a = D(i) ? i : e.default;
    if ('array' === J(e.type))
      if (g(a))
        a.map((t) => {
          r.push(ie(e.items, t));
