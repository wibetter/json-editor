    ...
    (t =
      e && N(e)
        ...
        : e && x(e)
          ...
          : (function (e) {
              var t = '';
              if (O(e)) t = r(c.boolean);
              else if (b(e)) t = r(c.number);
                ...
                try {
                  t = b(JSON.parse(e)) ? r(c.input) : r(c.json);
                } catch (i) {
  ...
  N(e)
    ? Object.keys(e).map(function (i) {
        var a = e[i],
          o = t ? t + '-' + i : i;
        N(a) || x(a)
          ? r.push({ title: i, value: o, key: o, children: te(a, o) })
    ...
    : x(e) &&
      e.map(function (e, i) {
        var a = i.toString(),
          o = t ? t + '-' + i : a;
        N(e) || x(e)
          ? r.push({ title: a, value: o, key: o, children: te(e, o) })
