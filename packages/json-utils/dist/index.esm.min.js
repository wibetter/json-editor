...
function l(e, t) {
  for (var r = t, i = '', a = e.split('-'), n = 0, o = a.length; n < o; n++) {
    var p = a[n];
      ...
      e && N(e)
        ? (function (e) {
            ...
            if (N(e)) {
              ...
              e.data && e.filter && 2 === i.length
                ? (t = x(e.data) || N(e.data) ? r(m.local) : r(m.remote))
                : e.trigger && e.eventData && 2 === i.length
                  ? (t = r(y.emit))
                  : e.register && e.actionFunc && 2 === i.length
                    ? (t = r(y.on))
                    : e.quantity && S(e.quantity) && 2 === i.length
                      ? (t = r(c.quantity))
                      : ((t = r(c['empty-object'])),
        ...
        : e && x(e)
          ...
          : (function (e) {
              ...
              else if (v(e)) t = r(c.number);
              else if (g(e)) t = r(c.url);
              else if (j(e)) t = r(c.date);
              else if (q(e)) t = r(c['date-time']);
              else if (h(e)) t = r(c.time);
              else if (F(e)) t = r(c.color);
              else
                try {
                  t = v(JSON.parse(e)) ? r(c.input) : r(c.json);
                } catch (i) {
...
function G(e, t) {
  var r = t || {};
  if (N(e) && 'object' === e.type && e.properties) {
...
function M(e) {
  ...
  if (
    ...
    var i = t.properties,
      n = r(c.quantity);
    if (i.quantity && N(i.quantity) && i.quantity.default) {
  ...
  if ('datasource' === t.format) {
    var p = t.properties,
      ...
      d = p.data && p.data.default,
      s = p.filter && p.filter.default;
    'local' === l
      ? ((t = r(m.local)).properties.data.default = d ? r(d) : '{}')
      : ((t = r(m.remote)).properties.data.default = d ? r(d) : 'http://xxx'),
  ...
  if ('event' === t.format) {
    ...
    if ('in' === f || 'on' === f) {
      ...
      var O = (u.filter && u.filter.default) || '{}';
      (t = r(y.emit)),
        u.eventData &&
          N(u.eventData) &&
          (t.properties.eventData.default = u.eventData.default || r(O));
    }
  }
  return (
    t.properties &&
...
function Q(e, t) {
  ...
  if (N(e) && 'object' === e.type) {
    ...
    if ('dynamic-data' === n)
      (i = r(f)),
        l && N(l) && '{}' !== JSON.stringify(l) && (i = Object.assign(i, l));
...
function X(e, t) {
  return 'object' === e.type ? Q(e, t) : 'array' === e.type ? V(e, t) : P(e, t);
}
var Y = c;
function _(e, t) {
  var r = t || [];
  ...
  N(e)
    ? Object.keys(e).map(function (i) {
        var a = e[i],
          n = t ? t + '-' + i : i;
        N(a) || x(a)
          ? r.push({ title: i, value: n, key: n, children: te(a, n) })
    ...
    : x(e) &&
      e.map(function (e, i) {
        var a = i.toString(),
          n = t ? t + '-' + i : a;
        N(e) || x(e)
          ? r.push({ title: a, value: n, key: n, children: te(e, n) })
...
export {
  ...
  ae as KeyWordList,
  c as TypeDataList,
  ee as dataRoute2dataPath,
  _ as dynamicDataAnalyzer,
  E as getCurPosition,
  ...
  re as getParentKeyRoute,
  ie as getParentKeyRoute_CurKey,
