    ...
    return (
      (function () {
        ...
        ((0, h.__decorate)(
          ...
          (0, h.__decorate)([m.observable], R.prototype, 'jsonSchema', void 0),
          (0, h.__decorate)(
            [m.observable],
            R.prototype,
            'SchemaTypeList',
          ...
          (0, h.__decorate)([m.observable], R.prototype, 'onChange', void 0),
          (0, h.__decorate)(
            [m.action.bound],
            R.prototype,
            'triggerChangeAction',
          ...
          (0, h.__decorate)([m.computed], R.prototype, 'JSONSchemaObj', null),
          (0, h.__decorate)(
            [m.action.bound],
            R.prototype,
            'initOnChange',
          ...
          (0, h.__decorate)([m.action.bound], R.prototype, 'changeType', null),
          (0, h.__decorate)(
            [m.action.bound],
            R.prototype,
            'updateSchemaData',
          ...
          (0, h.__decorate)([m.action.bound], R.prototype, 'editJsonKey', null),
          (0, h.__decorate)(
            [m.action.bound],
            R.prototype,
            'addNextJsonData',
          ...
          (0, h.__decorate)([m.action.bound], R.prototype, 'addEnumItem', null),
          (0, h.__decorate)(
            [m.action.bound],
            R.prototype,
            'copyEnumItem',
        ...
        var j = { schemaStore: R },
          I = require('@babel/runtime/helpers/objectWithoutPropertiesLoose'),
          N = n.n(I),
          K = require('@ant-design/icons'),
          _ = require('@wibetter/json-editor'),
          w = n.n(_),
          B = (function (e) {
            function t() {
          ...
          J = (0, p.inject)(function (e) {
            return { schemaStore: e.schemaStore };
          })((0, p.observer)(B)),
          T = (n(915), y.Select.Option),
          q = (function (e) {
            function t(t) {
              var n;
              return (
                      ...
                      i.createElement(
                          ...
                          i.createElement(
                            ...
                            !v &&
                              i.createElement(
                                y.Tooltip,
                                { title: '删除' },
                                i.createElement(K.CloseOutlined, {
                            ...
                            i.createElement(
                              ...
                              i.createElement(K.PlusOutlined, {
                            ...
                            j &&
                              i.createElement(
                                y.Tooltip,
                                { title: '数据项排序' },
                                i.createElement(K.SortAscendingOutlined, {
                                  className: 'operate-btn',
                            ...
                            !v &&
                              i.createElement(
                                ...
                                i.createElement(
                                  y.Tooltip,
                                  { title: '复制' },
                                  i.createElement(K.CopyOutlined, {
                                    className: 'operate-btn',
                                ...
                                i.createElement(
                                  y.Tooltip,
                                  { title: '按住进行拖拽' },
                                  i.createElement(K.DragOutlined, {
                        ...
                        E &&
                          i.createElement(
                            y.Tooltip,
                            { title: '高级设置' },
                            i.createElement(K.SettingOutlined, {
                              className: 'operate-btn',
                              onClick: function () {
          ...
          k = (0, p.inject)(function (e) {
            return { schemaStore: e.schemaStore };
          })((0, p.observer)(q)),
          P = y.Tree.TreeNode,
          D = function (e) {
            return s().createElement(k, t()({}, e));
          },
          A = function (e) {
            var t = e.jsonKey,
              n = e.indexRoute,
                  ...
                  (n.onDrop = function (e) {
                    ...
                    if (!u.isFixed) {
                      var h = a.indexRoute || a['data-indexRoute'],
                        m = (0, g.isSameParent)(p, h),
                        f = (0, g.getCurPosition)(p, h);
                      if (m)
                        (l(p, !0),
                          'before' === f && (h = (0, g.moveForward)(h)),
                          a.dragOverGapTop
                            ? s(h, c, u, 'before')
                        ...
                        (b(i(x) + '-' + c + '-' + v, C || S),
                          a.dragOverGapTop
                            ? 'after' === f
                              ? (l(p, !0), s(h, c, u, 'before'))
                              : (s(h, c, u, 'before', !0), l(p))
                            : (a.dragOver || a.dragOverGapBottom) &&
                              ('after' === f
                                ? (l(p, !0), s(h, c, u))
                                : (s(h, c, u, '', !0), l(p))));
          ...
          Q = ['description', 'showKey', 'onShow', 'titleStyle'],
          Y = {
            readOnly: {
              type: 'boolean',
              title: '是否只读',
        ...
        var ee = {
          ...
          propsSchema: $(
            'input 高级配置',
            t()({}, Y, {
              isConditionProp: Y.isConditionProp,
              default: {
                type: 'input',
                title: '默认值',
                placeholder: '请输入默认值',
        ...
        var se = function (e) {
          ...
          pe = {
            ...
            renderer: A,
            propsSchema: se('htmlarea 高级配置'),
          };
        C.registerAll([le, de, pe]);
        var ce = function (e) {
            return $(
              e,
              {
          ...
          me = {
            ...
            renderer: A,
            propsSchema: ce('time 高级配置'),
          };
        C.registerAll([ue, he, me]);
        var ye = {
          type: 'input-image',
          label: '图片上传',
          isContainer: !1,
        ...
        var fe = y.Select.Option,
          ...
          ve = (0, p.inject)(function (e) {
            return { schemaStore: e.schemaStore };
          })((0, p.observer)(ge)),
          Se = y.Tree.TreeNode,
          be = function (e) {
            return s().createElement(ve, t()({}, e));
          },
          xe = function (e) {
            var n,
              a = e.jsonKey,
            ...
            return s().createElement(
              Se,
              {
                ...
                'data-indexRoute': o || '0',
                'data-jsonKey': a,
                title: ((n = t()({}, e)), s().createElement(k, t()({}, n))),
              },
              d &&
                d.length > 0 &&
                d.map(function (e, t) {
                ...
                return i.createElement(
                  ...
                  i.createElement(
                    ...
                    i.createElement(
                      ...
                      i.createElement(je, { key: a, value: a }, a),
                    ),
                  ),
                  i.createElement(
                    'div',
        ...
        var Fe = (function (e) {
          ...
          return (
            r()(n, e),
            (n.registerElement = function (e) {
              C.register(e);
            }),
            (n.registerElements = function (e) {
              C.registerAll(e);
            }),
            ...
            (n.prototype.render = function () {
              var e = this.props.element,
                ...
                a = i.createElement(
                  p.Provider,
                  { schemaStore: n },
                  i.createElement(Z, t()({}, this.props)),
                );
