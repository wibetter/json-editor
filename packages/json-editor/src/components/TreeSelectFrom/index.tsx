...
interface TreeSelectFromProps {
  mockData?: any; // 接口mock数据
  dataRoute?: any; // 数据路径
  onChange?: (value: any) => void; // 数据路径值变动后触发
  nodeKey?: string;
  pageScreen?: string;
}

class TreeSelectFrom extends React.PureComponent<TreeSelectFromProps> {
