    ...
    this.state = {
      jsonSchema: {
        ...
        properties: {
          func: {
            ...
            required: ['columns', 'mainTitle', 'dataApi', 'getDataCallback'],
          },
          style: {
            type: 'object',
            format: 'style',
      ...
      jsonData: {
        func: {
          mainTitle: '我的审核',
          dataApi:
            'http://hulk-test-test2.yigou.svc.hc04.n.jd.local/api/approval/queryList',
          getDataCallback:
            '(res, succCallBack, errorCallBack) => {\n    if (res && res.code === 0) {\n      succCallBack(res.data);\n    } else if (res.msg) {\n      errorCallBack(res.msg);\n    } else {\n      errorCallBack("接口请求失败");\n    }\n  }',
        },
        style: {
          backColor: '#fff',
          isShowTitle: false,
        ...
        data: {
          columns: [
            ...
            {
              title: '业务名称',
              key: 'applyBusinessName',
              width: 100,
            },
            {
              title: '业务所属部门',
              key: 'applyBusinessDepartment',
              width: 100,
            },
            {
              title: '业务负责人',
              key: 'applyBusinessErp',
              width: 100,
            },
            {
              title: '业务申请人',
